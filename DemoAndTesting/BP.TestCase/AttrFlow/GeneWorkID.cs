...
namespace BP.CT.AttrFlow
{
    ...
    public  class GeneWorkID : TestBase
    {
        ...
        public override void Do()
        {
            ...
            // 创建空白工作, 在标题为空的情况下.
            workID = BP.WF.Dev2Interface.Node_CreateBlankWork(fk_flow, null, null, WebUser.No, "TitleTest", 0, null);

            #region 检查数据是否符合预期.
            #endregion 检查数据是否符合预期

            //在执行一次创建.
            Int64 workID2 = BP.WF.Dev2Interface.Node_CreateBlankWork(fk_flow, null, null, WebUser.No, "TitleTest", 0, null);
            if (workID != workID2)
             ...
             //在执行一次创建.
               workID2 = BP.WF.Dev2Interface.Node_CreateBlankWork(fk_flow, null, null, WebUser.No, "TitleTest", 0, null);
