...
namespace BP.CT.AttrFlow
{
    ...
    public  class CreateStartWork : TestBase
    {
        ...
        public override void Do()
        {
            ...
            // 创建空白工作, 在标题为空的情况下.
            workID = BP.WF.Dev2Interface.Node_CreateStartNodeWork(fk_flow, null, null, WebUser.No, "TitleTest", 0, null);

            //在执行一次创建.
            Int64 workID2 = BP.WF.Dev2Interface.Node_CreateStartNodeWork(fk_flow, null, null, WebUser.No, "TitleTest", 0, null);
