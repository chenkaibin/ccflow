...
public partial class AppDemo_Default : System.Web.UI.Page
{
    ...
    public string mainSrc = "../WF/StartSmall.aspx";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (this.Request.QueryString.Count > 0)
        {
            ...
            mainSrc = "../WF/MyFlowSmall.aspx?FK_Flow=" + this.FK_Flow + paras + "&FK_Node=" + FK_Node;
            //Page.RegisterStartupScript("restartup", "<script>window.frames[\"main\"].src = '../WF/MyFlow.aspx?FK_Flow=" + this.FK_Flow + paras + "&FK_Node=" + FK_Node + "'</script>");
            //ClientScript.RegisterStartupScript(ClientScript.GetType(), "", "<script>window.top.frames[1].main.location.href = './../WF/MyFlowSmall.aspx?FK_Flow=" + this.FK_Flow + paras + "&FK_Node=" + FK_Node + "'</script>");
            //Response.Redirect("./../WF/MyFlowSmall.aspx?FK_Flow=" + this.FK_Flow + paras + "&FK_Node=" + FK_Node);
        }
    }
}