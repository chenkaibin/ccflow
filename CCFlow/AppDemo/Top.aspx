<%@ Page Language="C#" AutoEventWireup="true" Inherits="AppDemo_Top" CodeBehind="Top.aspx.cs" %>
        ...
        <div class="JS_haed_n">
            <div class="JS_admin fr">
                <p>
                    ...
                    帐号：<span><%=BP.Web.WebUser.No.ToString() %></span> 姓名：<span> <a href="javascript:void(0)" onclick="window.top.main.location.href = './../WF/ToolsSmall.aspx'">
