...
namespace CCFlow.WF.CCForm
{
    public partial class WF_DtlSearch : BP.Web.WebPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dtls.Count == 1)
            {
                this.Response.Redirect("/WF/Comm/PanelEns.aspx?EnsName=" + dtls[0].GetValStrByKey("No"), true);
                return;
            }
            ...
            {
                this.Pub1.AddLi("/WF/Comm/PanelEns.aspx?EnsName=" + dtls[0].GetValStrByKey("No"), dtl.Name);
            }
            this.Pub1.AddULEnd();
