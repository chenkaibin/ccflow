    ...
    public partial class WF_DtlOpt : WebPage
    {
        ...
        private void BindExpImp()
        {
            ...
            if (dtl.IsExp)
            {
                ...
                this.Pub1.Add("<p align=center><a href='" + urlExp + "' target=_blank ><img src='/WF/Img/FileType/xls.gif' border=0 /><b>导出数据</b></a></p>");
            ...
            if (dtl.IsImp)
            {
                ...
                this.Pub1.Add("<p align=center><a href='" + url + "' target=_blank ><img src='/WF/Img/FileType/xls.gif' border=0 />数据模版</a></p>");
                this.Pub1.Add("<br>");
