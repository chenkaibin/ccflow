<%@ Page Language="C#" AutoEventWireup="true" Inherits="CCFlow.WF.CCForm.Comm_M2M" Codebehind="M2M.aspx.cs" %>
...
<head runat="server">
		...
		<script language="javascript" >
		    ...
		    function GroupBarClick(gID) {
		        ...
		        document.getElementById('I' + gID).src = '/WF/Img/' + alt + '.gif';
...
<body topmargin="0" leftmargin="0" onkeypress="Esc()" style="font-size:smaller"> 
    <form id="form1" runat="server">
     ...
     <asp:Button ID="Button1" runat="server" Text="保存"  CssClass="Btn" Visible=true
