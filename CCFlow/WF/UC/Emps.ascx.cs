    ...
    public partial class Emps : BP.Web.UC.UCBase3
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                if (WebUser.No == "admin")
                {
                    this.AddTD("<a href=\"javascript:DoUp('" + emp.No + "','" + keys + "')\" ><img src='/WF/Img/Btn/Up.gif' border=0 /></a>-<a href=\"javascript:DoDown('" + emp.No + "','" + keys + "')\" ><img src='/WF/Img/Btn/Down.gif' border=0 /></a>");
                }
                this.AddTREnd();
            }
            this.AddTableEnd();
