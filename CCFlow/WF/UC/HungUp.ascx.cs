...
namespace CCFlow.WF.UC
{
    public partial class HungUp : BP.Web.UC.UCBase3
    {
        ...
        public void BindList()
        {
            ...
            this.Pub1.AddCaptionLeft("<img src='/WF/Img/Runing.gif' >&nbsp;<a href='" + PageID + ".aspx?IsHungUp=1' >挂起工作</a>");
            ...
            foreach (string g in gVals)
            {
               ...
               //     int isRead = int.Parse(dr["IsRead"].ToString());
                    ...
                    {
                        this.Pub1.AddTD("Class=TTD onclick=\"SetImg('I" + gIdx + "_" + i + "')\"", "<a href=\"javascript:WinOpenIt('MyFlowSmall.aspx?FK_Flow=" + dr["FK_Flow"] + "&FK_Node=" + dr["FK_Node"] + "&FID=" + dr["FID"] + "&WorkID=" + dr["WorkID"] + "&IsRead=0');\" ><img src='/WF/Img/Mail_UnRead.png' id='I" + gIdx + "_" + i + "' border=0/>" + dr["Title"].ToString());
                        //      else
                        //        this.Pub1.AddTD("Class=TTD", "<a href=\"javascript:WinOpenIt('MyFlowSmall.aspx?FK_Flow=" + dr["FK_Flow"] + "&FK_Node=" + dr["FK_Node"] + "&FID=" + dr["FID"] + "&WorkID=" + dr["WorkID"] + "');\"  ><img src='/WF/Img/Mail_Read.png' id='" + gIdx + "_" + i + "' border=0/>" + dr["Title"].ToString());
                    }
                    else
                    {
