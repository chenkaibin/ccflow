...
namespace CCFlow.WF.UC
{
    public partial class GetTask : BP.Web.UC.UCBase3
    {
        ...
        public void BindWorkList()
        {
            ...
            this.AddCaptionLeft("<a href='GetTask" + pageid + ".aspx'><img src='/WF/Img/Start.gif' > <b>取回处理</b></a>");
            this.AddTR();
            this.AddTDTitle("序");
            this.AddTDTitle("标题");
            this.AddTDTitle("发起人");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (this.DoType == "Tackback")
            {
                ...
                try
                {
                    ...
                    //  s=s.Replace(
                    this.AddTable("width='960px' align=center");
                    this.AddCaptionLeft("<a href='GetTask" + pageid + ".aspx'><img src='/WF/Img/Start.gif' > <b>取回处理</b></a> - <a href=GetTask" + pageid + ".aspx?FK_Flow=" + this.FK_Flow + "&FK_Node=" + this.FK_Node + ">返回</a>");
                    this.AddTR();
                    this.AddTDBegin();
