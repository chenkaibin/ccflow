<%@ Control Language="C#" AutoEventWireup="true" Inherits="CCFlow.WF.UC.FHLFlow" Codebehind="FHLFlow.ascx.cs" %>
<%@ Register src="/WF/Comm/UC/ToolBar.ascx" tagname="ToolBar" tagprefix="uc1" %>
<%@ Register src="/WF/UC/UCEn.ascx" tagname="UCEn" tagprefix="uc2" %>
