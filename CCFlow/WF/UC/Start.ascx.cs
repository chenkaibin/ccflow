            ...
            foreach (Flow fl in fls)
            {
                ...
                if (fl.StartListUrl == "")
                {
                    if (Glo.IsWinOpenStartWork == 1)
                        this.AddTD("<a href=\"javascript:WinOpenIt('MyFlowSmall.aspx?FK_Flow=" + fl.No + "&FK_Node=" + int.Parse(fl.No) + "01&T="+this.timeKey+"');\" >" + fl.Name + "</a>");
                    ...
                    this.AddTD("<a href=\"javascript:StartListUrl('" + appPath + "','" + fl.StartListUrl + "?FK_Flow=" + fl.No + "&FK_Node=" + int.Parse(fl.No) + "01&T=" + this.timeKey + "','" + fl.No + "','" + pageid + "')\" >" + fl.Name + "</a>");
