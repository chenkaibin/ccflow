...
<script language="javascript" type="text/javascript">
    ...
    function HidShowSta() {
        if (document.getElementById('RptTable').style.display == "none") {
            ...
            document.getElementById('ImgUpDown').src = "/WF/Img/arrow_down.gif";
        }
        else {
            document.getElementById('ImgUpDown').src = "/WF/Img/arrow_up.gif";
    ...
    function GroupBarClick(rowIdx) {
        ...
        document.getElementById('Img' + rowIdx).src = '/WF/Img/' + alt + '.gif';
