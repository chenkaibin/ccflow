...
{
    public partial class FlowSearch : BP.Web.UC.UCBase3
    {
        #region 属性
        ...
        public void BindSearch()
        {
            ...
            this.Pub1.AddCaptionLeft("<img src='/WF/Img/EmpWorks.gif' > <b><a href=FlowSearch" + this.PageSmall + ".aspx >" + "流程查询" + "</a>-<a href='FlowSearch" + this.PageSmall + ".aspx?FK_Flow=" + nd.FK_Flow + "'>" + nd.FlowName + "</a>-" + nd.Name + "</b>");
            ...
            foreach (Entity en in wks)
            {
                ...
                this.Pub1.AddTD("<a href=\"./../WF/WFRpt.aspx?WorkID=" + en.GetValIntByKey("OID") + "&FID=" + en.GetValByKey("FID") + "&FK_Flow=" + nd.FK_Flow + "\" target=bk >报告</a>-<a href=\"./../WF/Chart.aspx?WorkID=" + en.GetValIntByKey("OID") + "&FID=" + en.GetValByKey("FID") + "&FK_Flow=" + nd.FK_Flow + "\" target=bk >轨迹</a>");
                this.Pub1.AddTREnd();
            }
        ...
        public void BindFlowWap()
        {
            ...
            this.Pub1.AddTR();
            this.Pub1.Add("<TD class=TitleMsg colspan=" + colspan + " align=left><img src='/WF/Img/Start.gif' > <b><a href='FlowSearch.aspx' >返回</a> - " + fl.Name + "</b></TD>");
            this.Pub1.AddTREnd();
        ...
        public void BindFlow()
        {
            ...
            this.Pub1.AddTR();
            this.Pub1.Add("<TD class=TitleMsg colspan=" + colspan + " align=left><img src='/WF/Img/Start.gif' > <b><a href='FlowSearch" + this.PageSmall + ".aspx' >返回</a> - " + fl.Name + "</b></TD>");
            this.Pub1.AddTREnd();
        ...
        public void BindMyWork()
        {
            ...
            this.Pub1.AddTR();
            this.Pub1.Add("<TD class=TitleMsg  align=left colspan=" + colspan + "><img src='/WF/Img/EmpWorks.gif' > <b><a href=FlowSearch" + this.PageSmall + ".aspx >流程查询</a>-<a href='FlowSearch" + this.PageSmall + ".aspx?FK_Flow=" + nd.FK_Flow + "'>" + nd.FlowName + "</a>-" + nd.Name + "</b></TD>");
            this.Pub1.AddTREnd();
        ...
        public void BindBill()
        {
            ...
            string src =  "/WF/Comm/PanelEns.aspx?EnsName=BP.WF.Bills&FK_Flow=" + this.FK_Flow;
            ...
            int i = 0;
            bool is1 = false;
            foreach (BP.WF.Bill bill in bills)
            {
                this.Pub1.AddTR(is1);
                i++;
                ...
                this.Pub1.AddTDA("javascript:WinOpen('" + bill.Url + "')", "<img src='/WF/Img/Btn/Word.gif' border=0 />" + bill.FK_BillText);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (WebUser.IsWap)
                this.Pub1.AddCaption("<img src='/WF/Img/Home.gif' ><a href='Home.aspx' >Home</a> - <img src='/WF/Img/Search.gif' > -  流程查询" );
            else
                this.Pub1.AddCaptionLeft("<img src='/WF/Img/Search.gif' > <b>流程查询-分析</b> <span style='float:right'><a href=\"javascript:WinOpen('KeySearch.aspx',900,900); \">关键字查询</a> | <a href=\"javascript:WinOpen('/WF/Comm/PanelEns.aspx?EnsName=BP.WF.FlowDatas',900,900); \">综合查询</a> | <a href=\"javascript:WinOpen('/WF/Comm/GroupEnsMNum.aspx?EnsName=BP.WF.FlowDatas',900,900); \">综合分析</a> ");
            ...
            foreach (FlowSort fs in fss)
            {
                ...
                foreach (Flow fl in fls)
                {
                    ...
                    if (WebUser.IsWap == false)
                        this.Pub1.AddTD("width='60%'", "<a href=\"javascript:WinOpen('Chart.aspx?FK_Flow=" + fl.No + "&DoType=Chart','sd');\"  >" + fl.Name + "</a>");
                    else
                    ...
                    else
                    {
                        ...
                        this.Pub1.AddTD("<a href=\"javascript:WinOpen('" + src + "');\"  ><img src='/WF/Img/Btn/Word.gif' border=0/>" + bill + "</a>");
                    }
                    this.Pub1.AddTDBegin();
        ...
        public void BindWap()
        {
            this.Pub1.AddFieldSet("<a href='Home.aspx' ><img src='/WF/Img/Home.gif' >Home</a>");
            Flows fls = new Flows();
            fls.RetrieveAll();
            FlowSorts fss = new FlowSorts();
            fss.RetrieveAll();
        ...
        {
            this.Pub1.AddFieldSet("<img src='/WF/Img/Home.gif' ><a href='Home.aspx' >Home</a>");
            ...
            foreach (FlowSort fs in fss)
            {
                ...
                foreach (Flow fl in fls)
                {
                    ...
                    {
                        string src =  "/WF/Comm/PanelEns.aspx?EnsName=BP.WF.Bills&FK_Flow=" + fl.No;
                        this.Pub1.Add("<a href=\"javascript:WinOpen('" + src + "');\"  >" + bill + "</a>");
                    }


                    string src1 = "/WF/Comm/PanelEns.aspx?EnsName=ND" + int.Parse(fl.No) + "Rpt";
