...
namespace CCFlow.WF
{
    public partial class WF_WFDtl : WebPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Ucsys1.AddCaptionLeft(map.EnDesc + " - <a href='WFRptDtl.aspx?RefPK=" + this.RefPK + "&EnName=" + this.EnName + "&DoType=Exp' ><img src='/WF/Img/Btn/Excel.gif' border=0>输出到Excel</a>");
            this.Ucsys1.AddTR();
