    ...
    public partial class Comm_MapDef_EditTable : BP.Web.WebPage
    {
        ...
        public void BindTable(MapAttr mapAttr)
        {
            ...
            if (mapAttr.UIBindKey.Contains("."))
                this.Pub1.AddTD("<a href=\"javascript:WinOpen('/WF/Comm/PanelEns.aspx?EnsName=" + mapAttr.UIBindKey + "','df');\" >打开</a>");
            else
                this.Pub1.AddTD("<a href=\"javascript:WinOpen('/WF/MapDef/SFTableEditData.aspx?RefNo=" + mapAttr.UIBindKey + "','df');\" >打开</a>");
