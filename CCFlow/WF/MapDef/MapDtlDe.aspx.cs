    ...
    public partial class Comm_MapDef_MapDtlDe : WebPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (mes.Count != 0)
            {
             ...
             "<script language='JavaScript' src='/WF/CCForm/MapExt.js' ></script>");
       ...
       "<script language='JavaScript' src='/DataUser/JSLibData/" + this.FK_MapDtl + ".js' ></script>");
            ...
            //     this.Pub1.AddCaptionLeftTX("<a href='MapDef.aspx?MyPK=" + md.No + "' ><img src='/WF/Img/Btn/Back.gif' border=0/>" + this.ToE("Back","返回") + ":" + md.Name + "</a> - <img src='/WF/Img/Btn/Table.gif' border=0/>" + dtl.Name + " - <a href=\"javascript:AddF('" + this.MyPK + "');\" ><img src='/WF/Img/Btn/New.gif' border=0/>" + "新建字段" + "</a> ");
            ...
            foreach (MapAttr attr in attrs)
            {
                ...
                this.Pub1.Add("<TH>");
                this.Pub1.Add("<a href=\"javascript:Up('" + this.MyPK + "','" + attr.MyPK + "','" + t + "');\" ><img src='/WF/Img/Btn/Left.gif' class=Arrow alt='向左移动' border=0/></a>");
                ...
                //  this.Pub1.Add("[<a href=\"javascript:Insert('" + this.MyPK + "','" + attr.IDX + "');\" ><img src='/WF/Img/Btn/Insert.gif' border=0/>插入</a>]");
                this.Pub1.Add("<a href=\"javascript:Down('" + this.MyPK + "','" + attr.MyPK + "','" + t + "');\" ><img src='/WF/Img/Btn/Right.gif' class=Arrow alt='向右移动' border=0/></a>");
                this.Pub1.Add("</TH>");
            }
            ...
            for (int i = 1; i <= dtl.RowsOfList; i++)
            {
                ...
                if (dtl.IsEnableAthM)
                    this.Pub1.AddTD("<a href=\"javascript:window.showModalDialog('/WF/CCForm/AttachmentUpload.aspx?IsBTitle=1&PKVal=0&Ath=AthM&FK_MapData=" + this.FK_MapDtl + "&FK_FrmAttachment=" + this.FK_MapDtl + "_AthM','dialogHeight: 500px; dialogWidth: 600px;center: yes; help: no')\"><img src='/WF/Img/AttachmentM.png' border=0 width='16px' /></a>");

                if (dtl.IsEnableM2M)
                    this.Pub1.AddTD("<a href=\"javascript:window.showModalDialog('/WF/CCForm/M2M.aspx?NoOfObj=M2M&IsTest=1&OID=0&FK_MapData=" + this.FK_MapDtl + "','m2m','dialogHeight: 500px; dialogWidth: 600px;center: yes; help: no')\"><img src='./../Img/M2M.png' border=0 width='16px' /></a>");

                if (dtl.IsEnableM2MM)
                    this.Pub1.AddTD("<a href=\"javascript:window.showModalDialog('/WF/CCForm/M2MM.aspx?NoOfObj=M2MM&IsTest=1&OID=0&FK_MapData=" + this.FK_MapDtl + "','m2m','dialogHeight: 500px; dialogWidth: 600px;center: yes; help: no')\"><img src='./../Img/M2MM.png' border=0 width='16px' /></a>");


                //if (dtl.IsEnableAthM)
                //    this.Pub1.AddTD("<a href=\"javascript:WinOpen('./../CCForm/AttachmentUpload.aspx?IsBTitle=1&PKVal=0&Ath=AthM&FK_MapData=" + this.FK_MapDtl + "&FK_FrmAttachment=" + this.FK_MapDtl + "_AthM')\"><img src='./../Img/AttachmentM.png' border=0 width='16px' /></a>");

                //if (dtl.IsEnableM2M)
                //    this.Pub1.AddTD("<a href=\"javascript:WinOpen('./../CCForm/M2M.aspx?NoOfObj=M2M&IsTest=1&OID=0&FK_MapData=" + this.FK_MapDtl + "')\"><img src='./../Img/M2M.png' border=0 width='16px' /></a>");

                //if (dtl.IsEnableM2MM)
                //    this.Pub1.AddTD("<a href=\"javascript:WinOpen('./../CCForm/M2MM.aspx?NoOfObj=M2MM&IsTest=1&OID=0&FK_MapData=" + this.FK_MapDtl + "')\"><img src='./../Img/M2M.png' border=0 width='16px' /></a>");
