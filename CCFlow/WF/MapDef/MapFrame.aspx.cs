...
namespace CCFlow.WF.MapDef
{
    public partial class WF_MapDef_MapFrame : WebPage
    {
        ...
        public void BindList(MapData md)
        {
            ...
            this.Pub1.AddTable();
            this.Pub1.AddCaptionLeft("<a href='MapDef.aspx?MyPK=" + this.MyPK + "'>返回:" + md.Name + "</a> - <a href='MapFrame.aspx?DoType=New&FK_MapData=" + this.FK_MapData + "&sd=sd'><img src='/WF/Img/Btn/New.gif' border=0/>新建</a>");
            this.Pub1.AddTR();
