    ...
    public partial class WF_MapDef_TabIdx : WebPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                this.Pub1.AddTD("<a href='TabIdx.aspx?DoType=Up&FK_MapData=" + this.FK_MapData + "&KeyOfEn=" + dr["KeyOfEn"].ToString() + "' ><img src='/WF/Img/Btn/Up.gif' border=0></a>");
                this.Pub1.AddTD("<a href='TabIdx.aspx?DoType=Down&FK_MapData=" + this.FK_MapData + "&KeyOfEn=" + dr["KeyOfEn"].ToString() + "' ><img src='/WF/Img/Btn/Down.gif' border=0></a>");
                this.Pub1.AddTREnd();
            }
