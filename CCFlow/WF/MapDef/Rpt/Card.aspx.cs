...
public partial class WF_MapDef_WFRpt : WebPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //  this.Pub1.AddB("-<a href=\"javascript:WinOpen('/WF/Comm/PanelEns.aspx?EnsName=" + this.MyPK + "')\">查询预览</a>");
        // this.Pub1.AddB("-<a href=\"javascript:WinOpen('/WF/Comm/GroupEnsMNum.aspx?EnsName=" + this.MyPK + "')\">分析预览</a>");
        ...
        #region 查询条件定义
        this.Pub1.AddFieldSet("查询条件定义" + " - <a href=\"javascript:WinOpen('../Rpt/Search.aspx?FK_Flow=" + this.FK_Flow + "')\">查询预览</a>-<a href=\"javascript:WinOpen('/WF/Comm/GroupEnsMNum.aspx?EnsName=" + this.MyPK + "')\">分析预览</a>");
