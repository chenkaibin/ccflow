...
DELETE FROM Port_Unit;

-- Port_Unit ;
INSERT INTO Port_Unit (No,Name,ParentNo) VALUES('1','济南驰骋信息技术有限公司','-1');
 
-- Port_Dept ;
INSERT INTO Port_Dept (No,Name,ParentNo,FK_Unit) VALUES('1','总经理室','-1','1');
INSERT INTO Port_Dept (No,Name,ParentNo,FK_Unit) VALUES('2','市场部','1','1')  ;
INSERT INTO Port_Dept (No,Name,ParentNo,FK_Unit) VALUES('3','研发部','1','1')  ;
INSERT INTO Port_Dept (No,Name,ParentNo,FK_Unit) VALUES('4','服务部','1','1')  ;
INSERT INTO Port_Dept (No,Name,ParentNo,FK_Unit) VALUES('5','财务部','1','1')  ;
INSERT INTO Port_Dept (No,Name,ParentNo,FK_Unit) VALUES('6','人力资源部','1','1');
...
-- Port_Emp ;
-- 总经理部 ;
INSERT INTO Port_Emp (No,Name,Pass,FK_Dept,FK_Unit) VALUES('admin','admin','pub','1','1')  ;
INSERT INTO Port_Emp (No,Name,Pass,FK_Dept,FK_Unit) VALUES('zhoupeng','周朋','pub','1','1')  ;

-- 市场部 ;
INSERT INTO Port_Emp (No,Name,Pass,FK_Dept,FK_Unit) VALUES('zhanghaicheng','张海成','pub','2','1')  ;
INSERT INTO Port_Emp (No,Name,Pass,FK_Dept,FK_Unit) VALUES('zhangyifan','张一帆','pub','2','1')  ;
INSERT INTO Port_Emp (No,Name,Pass,FK_Dept,FK_Unit) VALUES('zhoushengyu','周升雨','pub','2','1')  ;

-- 研发部 ;
INSERT INTO Port_Emp (No,Name,Pass,FK_Dept,FK_Unit) VALUES('qifenglin','祁凤林','pub','3','1')  ;
INSERT INTO Port_Emp (No,Name,Pass,FK_Dept,FK_Unit) VALUES('zhoutianjiao','周天娇','pub','3','1')  ;

-- 服务部经理 ;
INSERT INTO Port_Emp (No,Name,Pass,FK_Dept,FK_Unit) VALUES('guoxiangbin','郭祥斌','pub','4','1')  ;
INSERT INTO Port_Emp (No,Name,Pass,FK_Dept,FK_Unit) VALUES('fuhui','福惠','pub','4','1')  ;

-- 财务部 ;
INSERT INTO Port_Emp (No,Name,Pass,FK_Dept,FK_Unit) VALUES('yangyilei','杨依雷','pub','5','1')  ;
INSERT INTO Port_Emp (No,Name,Pass,FK_Dept,FK_Unit) VALUES('guobaogeng','郭宝庚','pub','5','1') ;

-- 人力资源部 ;
INSERT INTO Port_Emp (No,Name,Pass,FK_Dept,FK_Unit) VALUES('liping','李萍','pub','6','1')  ;
INSERT INTO Port_Emp (No,Name,Pass,FK_Dept,FK_Unit) VALUES('liyan','李言','pub','6','1')  ;
