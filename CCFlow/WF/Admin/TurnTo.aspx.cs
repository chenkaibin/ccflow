        ...
        public void BindNode()
        {
            ...
            if (conds.Count > 0)
            {
                ...
                foreach (TurnTo tt in conds)
                {
                    ...
                    this.Pub1.AddTDA("TurnTo.aspx?MyPK=" + tt.MyPK + "&FK_Node=" + tt.FK_Node, "<img src='/WF/Img/Btn/Edit.gif' />");
                    this.Pub1.AddTDA("TurnTo.aspx?MyPK=" + tt.MyPK + "&FK_Node=" + tt.FK_Node + "&DoType=Del", "<img src='/WF/Img/Btn/Delete.gif' />");
