       ...
       "<link href='./Style/Table" + BP.Web.WebUser.Style + ".css' rel='stylesheet' type='text/css' />");
            ...
            if (this.IsPostBack == false)
            {
                ...
                if (this.CheckBoxList1.Items.Count == 0)
                    throw new Exception(map.EnDesc + "  没有外键条件，不适合做分组查询" ); //没有外键条件，不适合做分组查询。
            ...
            //this.Label1.Controls.Add(this.GenerLabel("<img src='/WF/Img/Btn/DataGroup.gif' border=0  />" + lab));
            //this.Label1.Controls.Add(this.GenerLabel("<img src='/WF/Img/Btn/DataGroup.gif' border=0  />"+this.HisEn.EnDesc+"<img src='/WF/Img/Btn/Table.gif' border=0  /><a href='UIEns.aspx?EnsName="+this.HisEns.ToString()+"&Readonly=1'>查询</a><img src='/WF/Img/Btn/Table.gif' border=0  /><a href='UIEnsCols.aspx?EnsName="+this.HisEns.ToString()+"&IsReadonly=1'>选择列查询</a>")); 
            //this.Label1.Controls.Add(this.GenerLabel("<img src='/WF/Img/Btn/DataGroup.gif' border=0  />"+this.HisEn.EnDesc+"<img src='/WF/Img/Btn/Table.gif' border=0  /><a href='UIEns.aspx?EnsName="+this.HisEns.ToString()+"&Readonly=1'>查询</a><img src='/WF/Img/Btn/Table.gif' border=0  /><a href='UIEnsCols.aspx?EnsName="+this.HisEns.ToString()+"&Readonly=1'>选择列查询</a>")); 
        }
        ...
        public DataTable BingDG()
        {
            ...
            if (groupKey == "")
            {
                this.UCSys1.AddMsgOfWarning(  "预警",
                    "<img src='../Images/Pub/warning.gif' /><b><font color=red> 您没有选择分析的数据</font></b>"); //您没有选择分析的数据。
                return null;
            }
