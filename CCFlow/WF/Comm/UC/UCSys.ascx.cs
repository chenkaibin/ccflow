    ...
    public partial class UCSys : BP.Web.UC.UCBase
    {
        public static string FilesViewStr(string enName, object pk)
        {
            ...
            foreach (SysFileManager file in ens)
            {
                ...
                {
                    strs += "<a title='打开它' href=\"javascript:DoAction('/WF/Comm/Do.aspx?ActionType=" + (int)ActionType.DeleteFile + "&OID=" + file.OID + "&EnsName=" + enName + "&PK=" + pk + "','删除文件《" + file.MyFileName + file.MyFileExt + "》')\" ><img src='" + path + "/WF/Img/Btn/delete.gif' border=0 alt='删除此附件' /></a>&nbsp;";
                }
            }
            return strs;
        }
        ...
        public static string FilesViewStr1(string enName, object pk)
        {
            ...
            foreach (SysFileManager file in ens)
            {
                strs += "<img src='/WF/Img/FileType/" + file.MyFileExt.Replace(".", "") + ".gif' border=0 /><a href='/WF/" + file.MyFilePath + "' target='_blank' >" + file.MyFileName + file.MyFileExt + "</a>&nbsp;";
            }
            return strs;
        }
        ...
        public void ShowHidenMsg(string id, string title, string msg, bool isShowHelpIcon)
        {
            ...
            if (isShowHelpIcon)
                title = "<img src='/WF/Img/btn/help.gif' border=0 />" + title;


            msg = "<table class=Table id='t" + id + "' border=0 ><TR Class=TR ><TD class=TD  bgcolor=InfoBackground >" + msg + "</TD></TR></Table>";

            string str = "<A onclick='show" + id + "();' style='cursor:hand' > <FONT color='#008000' style='font-size:12px'  ><b>" + title + "</b><img src='/WF/Img/downUp.gif' id=Img" + id + "' ></FONT></A><span id='" + id + "'></span>";
        ...
        public void DataPanelDtl(Entities ens, string ctrlId, string colName, string urlAttrKey, string colUrl)
        {
            ...
            foreach (Entity en in ens)
            {
                ...
                this.Add("<TR  onmouseover=\"TROver(this,'" + this.Page.Request.ApplicationPath + "','" + ctrlId + "', '" + clName + "', '" + url + "');\" onmouseout='TROut(this)' ondblclick=\" WinOpen('/WF/Comm/RefFunc/UIEn.aspx?EnsName=" + ens.ToString() + "&PK=" + en.GetValByKey(pk) + url + "')\" >");
                idx++;
            ...
            foreach (Entity en in ens)
            {
                ...
                if (isRefFunc && IsEnableRefFunc)
                {
                    ...
                    foreach (RefMethod func in myreffuncs)
                    {
                        ...
                        //myurl="/WF/Comm/RefMethod.aspx?Index="+func.Index+"&EnsName="+ens.ToString() ;
                    ...
                    if (isShowOpenICON)
                        ...
                        this.Add("<TD class='TD' style='cursor:hand;' nowrap=true  >" + str + " </TD>");
                   // this.Add("<TD class='TD' style='cursor:hand;' nowrap=true  >" + str + " <a href=\"" + urlExt + "\" ><img src='/WF/Img/Btn/Open.gif' border=0/></a></TD>");
                ...
                else
                {
                    if (isShowOpenICON)
                        this.AddTD();
                    // this.Add("<TD class='TD' style='cursor:hand;' nowrap=true><a href=\"" + urlExt + "\" ><img src='/WF/Img/Btn/Open.gif' border=0/></a></TD>");
                    else
                        this.AddTD();
                }
                this.AddTREnd();
        ...
        public void DataPanelDtl(Entities ens, string ctrlId)
        {
           ...
           // this.AddTable("");
            ...
            foreach (Entity en in ens)
            {
                ...
                urlExt = "\"javascript:ShowEn('/WF/Comm/RefFunc/UIEn.aspx?EnsName=" + ens.ToString() + "&PK=" + en.GetValByKey(pk) + url + "', 'cd','" + WinCardH + "','" + WinCardW + "');\"";
                switch (tableStyle)
                {
                    case UIRowStyleGlo.None:
                        if (IsEnableDouclickGlo)
                ...
                {
                    string str = "";
                    // string str = "<a href=\"javascript:WinOpen('/WF/Comm/RefFunc/UIEn.aspx?EnsName=" + ens.ToString() + "&PK=" + en.GetValByKey(pk) + url + "', 'cd')\" >打开</a>";
                    //<a href=\"javascript:WinOpen('/WF/Comm/RefFunc/UIEn.aspx?EnsName=" + ens.ToString() + "&PK=" + en.GetValByKey(pk) + url + "','cd','400','600')\" >打开</A>
        ...
        public void DataPanelDtl(Entities ens, string ctrlId, string groupkey)
        {
         ...
         //   string cfgurl = "";
                ...
                || groupAttr.MyFieldType == FieldType.PKEnum)
            {
                ...
                foreach (SysEnum se in ses)
                {
                    ...
                    foreach (Entity en in ens)
                    {
                        ...
                        this.AddTRTXHand(" ondblclick=\"WinOpen('/WF/Comm/RefFunc/UIEn.aspx?EnsName=" + ens.ToString() + "&PK=" + en.GetValByKey(pk) + url + "')\"   onmousedown=\"OnDGMousedown('" + this.Page.Request.ApplicationPath + "','" + ctrlId + "', '" + clName + "', '" + url + "')\" ");
                        foreach (Attr attr in selectedAttrs)
                        {
            ...
            {
                Entities ensG = BP.DA.ClassFactory.GetEns(groupAttr.UIBindKey);
                ensG.RetrieveAll();
        ...
        public void DataPanelDtl(Entities ens, string ctrlId, string groupkey, string groupkey2)
        {
           ...
           // string cfgurl = "";
            ...
            if (groupAttr.MyFieldType == FieldType.Enum || groupAttr.MyFieldType == FieldType.PKEnum)
            {
                    ...
                    foreach (SysEnum se in ses)
                    {
                        ...
                        foreach (SysEnum se2 in ses2)
                        {
                            ...
                            foreach (Entity en in ens)
                            {
                                ...
                                string style = WebUser.Style;
                                string url = this.GenerEnUrl(en, attrs);
                                this.Add("<TR class='TR' ondblclick=\"WinOpen( '/WF/Comm/RefFunc/UIEn.aspx?EnsName=" + ens.ToString() + "&PK=" + en.GetValByKey(pk) + url + "')\"  onmousedown=\"OnDGMousedown('" + this.Page.Request.ApplicationPath + "','" + ctrlId + "', '" + clName + "', '" + url + "')\" onmouseover='TROver(this);OnDGMousedown('" + this.Page.Request.ApplicationPath + "','" + ctrlId + "', '" + clName + "', '" + url + "');' onmouseout='TROut(this)' >");
                                foreach (Attr attr in attrs)
                                {
                ...
                {
                    ensG2 = BP.DA.ClassFactory.GetEns(groupAttr2.UIBindKey);
                    ensG2.RetrieveAll();
                    ...
                    foreach (SysEnum se in ses)
                    {
                        ...
                        foreach (Entity enG2 in ensG2)
                        {
                            ...
                            foreach (Entity en in ens)
                            {
                                ...
                                string style = WebUser.Style;
                                string url = this.GenerEnUrl(en, attrs);
                                this.Add("<TR class='TR' ondblclick=\"WinOpen( '/WF/Comm/RefFunc/UIEn.aspx?EnsName=" + ens.ToString() + "&PK=" + en.GetValByKey(pk) + url + "')\"  onmouseover=\"TROver(this,'" + this.Page.Request.ApplicationPath + "','" + ctrlId + "', '" + clName + "', '" + url + "');\" onmouseout='TROut(this)' >");
                                foreach (Attr attr in attrs)
                                {
                                    if (attr.UIVisible == false || attr.Key == groupAttr2.Key || attr.Key == groupAttr.Key)
                                        continue;
        ...
        private void DataPanelCards(Entities ens, string ctrlId, string showtext1, bool showDtl)
        {
            ...
            foreach (Entity en in ens)
            {
                ...
                {
                    i = 0;
                    this.Add("<TD   valign=top ondblclick=\"WinOpen( '/WF/Comm/RefFunc/UIEn.aspx?EnsName=" + ens.ToString() + "&PK=" + en.GetValByKey(pk) + "')\"  onmousedown=\"OnDGMousedown('" + this.Page.Request.ApplicationPath + "','" + ctrlId + "', '" + clName + "', '" + url + "')\"  >" + img + "&nbsp;<b>" + en.GetValStringByKey(showtext1) + "</b>" + context + "</TD>");
                    this.AddTREnd();
                }
                else
                {
                    this.Add("<TD class='TD' valign=top ondblclick=\"WinOpen( '/WF/Comm/RefFunc/UIEn.aspx?EnsName=" + ens.ToString() + "&PK=" + en.GetValByKey(pk) + "')\"  onmousedown=\"OnDGMousedown('" + this.Page.Request.ApplicationPath + "','" + ctrlId + "', '" + clName + "', '" + url + "')\"  >" + img + "&nbsp;<b>" + en.GetValStringByKey(showtext1) + "</b>" + context + "</TD>");
                }
            }
        ...
        public void FilesView(string enName, string pk)
        {
            ...
            foreach (SysFileManager file in ens)
            {
                ...
                this.Add("<TD><img src='/WF/Img/FileType/" + file.MyFileExt.Replace(".", "") + ".gif' border=0 /><a href='" + this.Request.ApplicationPath + file.MyFilePath + "' target='_blank' >" + file.MyFileName + file.MyFileExt + "</a></TD>");
