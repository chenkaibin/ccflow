        ...
        public static string GetRefstrs(string keys, Entity en, Entities hisens)
        {
            ...
            if (oneVsM.Count > 0)
            {
                foreach (AttrOfOneVSM vsM in oneVsM)
                {
                    ...
                    string url = "/WF/Comm/UIEn1ToM.aspx?EnsName=" + en.ToString() + "&AttrKey=" + vsM.EnsOfMM.ToString() + keys;
                    string sql = "";
                    try
                    {
                        try
           ...
           // this.Add("<table border=0 cellpadding='0'  style='border-collapse: collapse;width:30%' cellspacing='0'  >");
                    ...
                    switch (attr.UIContralType)
                    {
                        case UIContralType.TB:
                            ...
                            if (attr.Key == noKey && attr.UIIsReadonly == false && attr.UIVisible == true)
                            {
                                ...
                                //string helpScript = "";
                                string helpScript = "<a href=\"javascript:alert('请在文本框上双击，系统会出现查找窗口。');\" ><img src='/WF/Img/Btn/Search.gif' border=0 /></a>";
            ...
            if (en.EnMap.Attrs.Contains("MyFileName"))
            {
                ...
                if (fileExt != "")
                {
                   ...
                   // url = "&nbsp;&nbsp;<a href='" + cf.FJWebPath + "/" + en.PKVal + "." + fileExt + "' target=_blank ><img src='"+this.Request.ApplicationPath+"Images/FileType/" + fileExt + ".gif' border=0 />" + fileName + "</a>";
                    url = "&nbsp;&nbsp;<a href='../Do.aspx?DoType=DownFile&EnName="+enName+"&PK="+en.PKVal+"' target=_blank ><img src='/WF/Img/FileType/" + fileExt + ".gif' border=0 />" + fileName + "</a>";
                ...
                if (fileExt != "")
                {
                    ...
                    btn1.ImageUrl = "/WF/Img/Btn/Delete.gif";
            ...
            foreach (AttrFile attrF in fileAttrs)
            {
                ...
                else
                {
                    ...
                    btn_m.ImageUrl = "/WF/Img/Btn/Delete.gif";

                    //btn_m.ImageUrl = "/WF/Img/Btn/Del.gif";
