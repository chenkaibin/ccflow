...
public partial class Comm_Sys_EnumList : BP.Web.WebPageAdmin
{
    public void BindRefNo()
    {
        ...
        this.UCSys1.AddCaptionLeft("<a href=EnumList.aspx ><img src='./../../Img/Btn/Home.gif' border=0>枚举值列表</a> -<a href='EnumList.aspx?DoType=New' ><img src='./../../Img/Btn/New.gif' border=0/>新建</a>- <img src='./../../Img/Btn/Edit.gif' border />编辑:" + sem.No + " " + sem.Name);
