    ...
    public partial class FrmTesting : Form
    {
        ...
        public void RunFlow(string fk_flow, string userNo, int runTimes)
        {
          ...
          //  fl.DoDelData();
            ...
            DataTable dt = BP.WF.Dev2Interface.DB_GenerEmpWorksOfDataTable(WFState.Runing, fk_flow);
            num = 0;
            ...
            //执行结束点.
            this.AddLog("=== 结束点开始执行");
            dt = BP.WF.Dev2Interface.DB_GenerEmpWorksOfDataTable(WFState.Runing, fk_flow);
            num = 0;
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                num++;
