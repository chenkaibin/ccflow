...
namespace BP.WF
{
    ...
    public class GenerWorkerList : Entity
    {
        ...
        public string FK_DeptT
        {
            get
            {
                Dept d = new Dept(this.FK_Dept1);
                return d.Name;
            }
        }
        public string FK_Dept1
        {
            get
            {
        ...
        public string Paras
        {
            get
            {
                return this.GetValStrByKey(GenerWorkerListAttr.Paras);
            }
            set
            {
                this.SetValByKey(GenerWorkerListAttr.Paras, value);
            }
        }
        /// <summary>
        /// 节点名称
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(GenerWorkerListAttr.Sender, null, "发送人", true, false, 0, 20, 100);
                ...
                //标签.
                map.AddTBString(GenerWorkerListAttr.Tag, null, "Tag", true, false, 0, 2000, 100);

                // 路由参数, 203-03-05 增加.
                map.AddTBString(GenerWorkerListAttr.Paras, null, "路由参数", true, false, 0, 2000, 100);
