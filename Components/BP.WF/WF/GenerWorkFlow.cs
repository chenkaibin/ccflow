	...
	{	
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(GenerWorkFlowAttr.FK_FlowSort, null, "流程类别", true, false, 0, 2, 10);
                ...
                map.AddTBString(GenerWorkFlowAttr.Starter, null, "发起人", true, false, 0, 20, 10);
                map.AddTBString(GenerWorkFlowAttr.StarterName, null, "发起人名称", true, false, 0, 30, 10);
