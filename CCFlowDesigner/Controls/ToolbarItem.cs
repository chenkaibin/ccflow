    ...
    public class ToolbarItem
    {
        ...
        public List<ToolbarItem> GetLists()
        {
            List<ToolbarItem> ToolList = new List<ToolbarItem>()
            {
                ...
                new ToolbarItem(){No="ToolBarNewNode", Name="节点"},
                new ToolbarItem(){No="ToolBarNewLine", Name="连线"},
                new ToolbarItem(){No="ToolBarNewReturnLine", Name="回线"},
                new ToolbarItem(){No="ToolBarNewLabel", Name="标签"},
